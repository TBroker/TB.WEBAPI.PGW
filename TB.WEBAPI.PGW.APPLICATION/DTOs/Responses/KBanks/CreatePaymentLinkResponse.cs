...
namespace TB.WEBAPI.PGW.APPLICATION.DTOs.Responses.KBanks
{
    public class CreatePaymentLinkResponse
    {
        ...
        public CreatePaymentLink? PaymentLink { get; set; }
    }
    ...
    public class CreatePaymentLink
    {
        ...
        public CreatePaymentLinkCardSmartpay? CardSmartpay { get; set; }
    }

    public class CreatePaymentLinkCardSmartpay
    {
        [JsonPropertyName("merchant_id")]
        public string? MerchantId { get; set; }
